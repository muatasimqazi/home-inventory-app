...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityFcm", path: "../../../node_modules/.pnpm/@capacitor-community+fcm@8.1.0_@capacitor+core@8.5.1/node_modules/@capacitor-community/fcm"),
        ...
        .package(name: "RevenuecatPurchasesCapacitor", path: "../../../node_modules/.pnpm/@revenuecat+purchases-capacitor@13.6.1_@capacitor+core@8.5.1/node_modules/@revenuecat/purchases-capacitor")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",

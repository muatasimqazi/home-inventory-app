    ...
    <main className="min-h-dvh bg-background px-6 py-10 text-ink">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-8">
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-body text-muted-foreground">For privacy questions, contact the Schuaz operator through the support channel where you received access to the app.</p>
        </section>
      </div>
    </main>
  );

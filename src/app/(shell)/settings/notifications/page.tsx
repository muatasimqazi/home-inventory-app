 ...
 *
 * The daily briefing (household.daily_briefing — a richer, separate
    ...
    <div className="flex flex-col gap-5">
      ...
      {state === "subscribed" && (
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <p className="text-body font-medium text-ink">Daily briefing</p>
            <p className="text-caption text-muted-foreground">Opt in for a greeting with weather, what to wear, and what&apos;s due — pick your own time</p>
          </div>

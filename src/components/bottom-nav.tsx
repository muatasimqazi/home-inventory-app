  ...
  return (
    <>
      <nav
        ...
        className="fixed inset-x-0 bottom-0 z-40 flex min-h-17.5 items-center border-t border-border bg-card px-2 pb-[env(safe-area-inset-bottom)] md:hidden print:hidden"
